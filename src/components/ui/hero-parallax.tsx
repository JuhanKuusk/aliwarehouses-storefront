...
export const HeroParallax = ({
  ...
  return (
    ...
    >
      <Header title={title} subtitle={subtitle} ctaText={ctaText} ctaLink={ctaLink} />
      <motion.div
        style={{
          rotateX,
          rotateZ,
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-gray-300">
        {subtitle ||
          "Shop quality products from verified EU warehouses with fast shipping across Europe. Home decor, lighting, furniture, and more."}
      </p>
      {ctaText && ctaLink && (
        <Link
          href={ctaLink}
          className="mt-8 inline-block rounded-full bg-white px-8 py-3 text-sm font-semibold text-black hover:bg-gray-100 transition-colors"
        >
          {ctaText}
        </Link>
      )}
